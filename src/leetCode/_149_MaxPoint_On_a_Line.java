package leetCode;
//This one is very trikcy on edge cases. I didn't make it work finally though spent so much time
// key idea is use hashmap hashes the line smartly
// using string record it's a, b ,c 
//A line is defined y=a/bx+c, so (a, b, c) will represent a unique line
//handles case such as vertical line and same points

import java.util.Collections;
import java.util.HashMap;
import java.util.Map;

public class _149_MaxPoint_On_a_Line {
