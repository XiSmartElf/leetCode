...
//so whenever this happens, we see 5(the biggest number) and the total is smaller. then we get rid of 5 and move to 1, replace 1 by 1's next value which is 3 in our test case
